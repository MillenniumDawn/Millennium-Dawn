...
#Retrieves a countries tech in history/country
def getCountriesTech(rootDir, tags, tagPos):
    with open(rootDir, 'r', encoding='utf-8', errors='ignore') as file:
        content = file.readlines()
        foundTech = 0
        openBrace = 0
...
#Retrieves a countries variants in history/country
def getCountriesVariants(rootDir, tags, tagPos):
    with open(rootDir, 'r', encoding='utf-8', errors='ignore') as file:
        content = file.readlines()
        foundVariant = 0
        openBrace = 0
...
def main():
    ...
    for root, dirnames, filenames in os.walk(rootDir + '/' + 'history' + '/countries' + '/'):
        for filename in fnmatch.filter(filenames, '*.txt'):
            ...
            if tagPos != -1:
                tags = getCountriesTech((os.path.join(root, filename)), tags, tagPos)
                tags = getCountriesVariants((os.path.join(root, filename)), tags, tagPos)
