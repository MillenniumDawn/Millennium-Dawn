	...
	NDefines.NMilitary.RIVER_CROSSING_PENALTY = -0.35 -- -0.3
	...
	NDefines.NMilitary.RECON_SKILL_IMPACT = 0.75 -- 5
	NDefines.NMilitary.ENEMY_AIR_SUPERIORITY_IMPACT = -0.75 -- -0.35
	...
	NDefines.NMilitary.UNIT_DIGIN_CAP = 8 -- 5
	...
	NDefines.NMilitary.AIR_SUPPORT_BASE = 0.75 -- 0.25
	...
	NDefines.NMilitary.COMBAT_OVER_WIDTH_PENALTY = -4 -- -2
	NDefines.NMilitary.COMBAT_OVER_WIDTH_PENALTY_MAX = -0.75 -- -0.33
	...
	NDefines.NMilitary.TRAINING_MAX_LEVEL = 7
	...
	NDefines.NMilitary.SHIP_MORALE_TO_ORG_REGAIN_BASE = 0.2 -- buffed from 0.2 -- Handles the Hourly Reorganization
	...
	NDefines.NAir.AIR_WING_AVERAGE_SIZE = 20 -- Eyeballed average amount of airplanes in the airwings
	...
	NDefines.NAI.MINES_SWEEPING_PLANES_PER_MAX_MINES = 5				-- 150
	...
	NDefines.NAI.MIN_CAPITALS_FOR_CARRIER_TASKFORCE = 3				-- 10
