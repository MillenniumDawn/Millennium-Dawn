...
python3 scripts/check_content_html.py  # raw HTML, duplicate H1s
python3 scripts/check_docs_hygiene.py --repo-root ..  # unused assets, naming
python3 scripts/check_site_links.py --site-dir dist  # broken links (needs build first)
```
