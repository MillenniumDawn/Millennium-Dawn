...
export const SITE_HEADER_CLASS = [
  ...
  "z-header",
  "w-full",
  "bg-[linear-gradient(135deg,var(--color-header-bg),var(--color-header-bg-end))]",
  "py-sm",
  "text-text-inverse",
  "shadow-md",
  "backdrop-blur-[6px]",
...
export const BACK_TO_TOP_CLASS = [
  ...
  "ease-[var(--transition-fn)]",
  "hover:scale-[1.06]",
  "hover:bg-[linear-gradient(135deg,var(--color-header-bg-end),var(--color-header-bg))]",
  "active:scale-95",
...
export const COUNTRY_FLAG_OVERLAY_CLASS = [
  ...
  "-z-[2]",
  "opacity-[0.28]",
  "[background-image:linear-gradient(135deg,var(--color-surface-muted-overlay)_0%,transparent_40%),var(--country-flag-image)]",
  "[background-position:center,center]",
  "[background-repeat:no-repeat,no-repeat]",
  "[background-size:cover,cover]",
  "[mask-image:linear-gradient(180deg,var(--color-mask-solid)_0%,var(--color-mask-mid)_48%,var(--color-mask-mid-38)_72%,var(--color-mask-fade)_100%)]",
  "[html.dark-mode_&]:opacity-40",
].join(" ");
