	...
	NDefines.NMilitary.RECON_SKILL_IMPACT = 7 -- 5
	...
	NDefines.NMilitary.AIR_SUPPORT_BASE = 0.4 -- 0.25
	...
	NDefines.NMilitary.UNIT_UPKEEP_ATTRITION = 0.02 -- 0.0 -- Test this one! 
	...
	NDefines.NMilitary.UNIT_EXPERIENCE_PER_TRAINING_DAY = 0.0008
	...
	NDefines.NAir.AIR_WING_XP_TRAINING_MISSION_GAIN_DAILY = 2 -- 3.3
	...
	NDefines.NNavy.TRAINING_EXPERIENCE_FACTOR = 0.1 -- 0.3
