...
localisation and must not carry any. The check runs in both directions.
"""
...
def _results_for(factories, loc_keys, monkeypatch, ai_only_by_category=()):
...
def _write_mod(tmp_path, category_visible):
