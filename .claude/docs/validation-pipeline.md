...
- `validate_scripted_localisation.py` runs **CI-only** in strict mode and gates missing or unused scripted-localisation findings in `localisation/english` and `common/scripted_localisation`.
