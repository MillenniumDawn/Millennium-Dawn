	...
	NDefines.NMilitary.ATTRITION_EQUIPMENT_LOSS_CHANCE = 0.03 -- 0.1
	NDefines.NMilitary.ATTRITION_EQUIPMENT_PER_TYPE_LOSS_CHANCE = 0.03 -- 0.1
	...
	NDefines.NMilitary.UNIT_UPKEEP_ATTRITION = 0.01 -- 0.0 -- Test this one! 
