...
| **validate_gfx_references.py**        | Sprite names in `.gui` and scripted-GUI files are defined in `interface/*.gfx`. Opt-in: `--report-unused` (sprites defined but never referenced; engine-resolved equipment icons and loc `£name` refs count as used)                                                                                                                                                                                                              |
