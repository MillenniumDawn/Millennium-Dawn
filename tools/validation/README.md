...
| **validate_focus_tree.py**            | Duplicate focus IDs; orphan focuses; missing prerequisite targets; missing loc keys; dependency cycles. Opt-in: `--missing-icons` (focuses whose `icon` sprite is undefined). Bonus `name =` parameters moved to `validate_bonus_names.py`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
